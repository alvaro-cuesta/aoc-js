...
describe('intcode', () => {
  ...
  describe('Day 9 specs', () => {
    test('Quine', () => {
      ...
      const EXPECTED_RAM = [...RAM]

      EXPECTED_RAM[100] = 16
      EXPECTED_RAM[101] = 1

      expect(intcode.runToHalt([], RAM)).toStrictEqual({
        ram: EXPECTED_RAM,
        ip: 15,
        base: 16,
        halted: true,
    ...
    test('16 digit', () => {
      ...
      const RAM = [1102, 34915192, 34915192, 7, 4, 7, 99, 0]
      const NUMBER = 1219070632396864

      expect(intcode.runToHalt([], RAM)).toStrictEqual({
        ram: R.update(7, NUMBER, RAM),
        ip: 6,
        base: 0,
        halted: true,
        input: [],
    ...
    test('Large number', () => {
      ...
      const RAM = [104, 1125899906842624, 99]
